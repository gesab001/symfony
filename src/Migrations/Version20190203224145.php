 ...
 */
final class Version20190203224145 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE videos CHANGE url url VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE videos CHANGE url url VARCHAR(255) DEFAULT \'https://s3-ap-southeast-2.amazonaws.com/adventistsermonvideos/\' COLLATE utf8mb4_unicode_ci');
    }
}
